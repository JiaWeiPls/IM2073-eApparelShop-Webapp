...
@WebServlet("/shirtmemcfm")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)

public class ShirtMemCfmServlet extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try (
         ...
         String sqlStr = "select id, name, email from member_acc where name ='" + request.getParameter("name") + "'";
         ...
         if (count == 0){
            ...
            out.println("<h2> A total of $" + total_price + ".00 has been billed to you. </h2>");
