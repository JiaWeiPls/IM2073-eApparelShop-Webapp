...
@WebServlet("/shirtadminorder")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)

public class ShirtAdminOrderServlet extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try (
         ...
         String sqlStr2 = "select designs.price, colour, design_name, size from cust_orders left join designs on cust_orders.design_id = designs.id";
         ...
         while(rset2.next()) {
               ...
               if(count == 0) {
                     ...
                     out.println("<h2> Orders from customers </h2>");
         ...
         if(count != 0) {
            ...
            out.println("     <tr><td style='width: 131.333px; text-align: center; colspan='2''>&nbsp;<form action = 'shirtadmincfm'>");
